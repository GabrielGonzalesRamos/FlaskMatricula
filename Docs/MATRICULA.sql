...
SELECT CURSO.NOMBRE, COUNT(ALUMNO_CURSO.ID_CURSO)
FROM TB_CURSO CURSO
JOIN TB_ALUMNO_CURSO ALUMNO_CURSO
ON CURSO.ID = ALUMNO_CURSO.ID_CURSO
GROUP BY CURSO.NOMBRE
ORDER BY COUNT(CURSO.NOMBRE)
...
SELECT CONCAT(ALUMNO.NOMBRE,' ',ALUMNO.APELLIDO) AS NOMBRE_COMPLETO,  CURSO.NOMBRE 
FROM TB_ALUMNO ALUMNO 
JOIN TB_ALUMNO_CURSO ALUMNO_CURSO 
ON ALUMNO.ID = ALUMNO_CURSO.ID_ALUMNO 
JOIN TB_CURSO CURSO 
ON CURSO.ID = ALUMNO_CURSO.ID_CURSO 
WHERE ALUMNO.APELLIDO LIKE '%Chavez Rojas%'
